...
public final class WebServiceCep {
    ...
    /**
     * Classe utilit�ria apenas encapsula o Iterator de elements da root dentro
    ...
    private static final class XmlEnums {
         ...
         *
         * @see Xml
         * @param xmlName {@link String} contendo o nome do enumeration
         * {@link Xml}.
     ...
     * @throws DocumentException Quando h� problema na forma��o do documento
     * XML.
     ...
     * <tt>{@link Iterable}<{@link Element}></tt> podendo ser recuperados um a
     * um dentro de um for
     * <BR>
     * <BR>Por exemplo:
     ...
     * objeto {@link WebServiceCep}.
     * <BR>
     * <BR>N�o se faz necess�rio formata��es, a string pode ser enviada em
     * qualquer formata��o, pois s� ser�o consideradas os primeiros 8 numeros da
     * string.
     * <BR>Por Exemplo:
     ...
     *
     * @param	cep N�mero do cep a ser carregado. S� ser�o considerados os
     * primeiros 8 n�meros da {@link String} enviada. Todos os caracters n�o
     * num�ricos ser�o removidos, e a string ser� truncada caso seja maior que 8
     * caracters.
    ...
    /**
     * Privado para que seja invocado apenas atrav�s de
     ...
     * <BR><tt>-14</tt> : Site n�o encontrado (pode ser por problemas na
     * internet).
    ...
    /**
     * Pega a exce��o que ocorreu durante a busca, retorna null caso n�o haja
     * exce��es.
     *
